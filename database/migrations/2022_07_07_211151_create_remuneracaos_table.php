...
class CreateRemuneracaosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('remuneracaos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('remuneracaos');
    }
}

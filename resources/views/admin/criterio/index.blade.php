...
@section('conteudo')
    ...
    @isset($page)
        @if ($page=="lista")
        @if (Auth::user()->tipo_conta == "Administrador" || \App\Models\Acesso::where("idUser",Auth::user()->id)->where("menu","Critérios")->where("nivel",">=",2)->get()->first())
                                    ...
                                    <td>
                                        ...
                                        <span class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-center dropdown-menu-arrow messages">
                                               ...
                                               @if (Auth::user()->tipo_conta == "Administrador" || \App\Models\Acesso::where("idUser",Auth::user()->id)->where("menu","Critérios")->where("nivel",">=",3)->get()->first())
                                              ...
                                              <li>
                                               ...
                                               @if (Auth::user()->tipo_conta == "Administrador" || \App\Models\Acesso::where("idUser",Auth::user()->id)->where("menu","Critérios")->where("nivel",">=",4)->get()->first())
                                              <li class="message-item">
                                              ...
                                              <li>
                                               ...
                                               @if (Auth::user()->tipo_conta == "Administrador" || \App\Models\Acesso::where("idUser",Auth::user()->id)->where("menu","Critérios")->where("nivel",">=",5)->get()->first())
                                              <li class="message-item">
